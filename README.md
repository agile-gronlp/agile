...
**This branch contains a new version of AGILe trained on more inscriptions and with an augmented lexicon:** 
...
mkdir agile-new25
cd agile-new25
git clone -b new25inscr --single-branch https://github.com/agile-gronlp/agile
```
